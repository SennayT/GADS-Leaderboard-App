 ...
 * Use the {@link HoursList#newInstance} factory method to
 * create an instance of this fragment.
 */
public class HoursList extends Fragment {
...
//    private String mParam2;
     ...
     *
     *
     * @return A new instance of fragment HoursList.
     */
...
//            mParam2 = getArguments().getString(ARG_PARAM2);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_hours_list, container, false);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        RecyclerView rvHours = view.findViewById(R.id.rvHours);
